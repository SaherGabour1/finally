...
<body>
    ...
    <br>
    <h2 class="middle-title">דוח התורמים</h2>
    ...
    <br></br>
           ...
           <form action="" method="POST">
            <input class="container1"  type="submit" value="חפש" name="submit">
              <input class="container2"  type="text" placeholder = "תחפש תורם לפי ת''ז" name="key" required pattern="[0-9]{9}" onkeypress="return onlyNumberKey(event)" maxlength="9">
          ...
          <br>
                ...
                <?php
                        ...
                        if(isset($_POST['submit'])){ 
                                ...
                                $value = $_POST['key'];
                                $query = " SELECT * FROM users where idnum  ='$value' and usertype='volnteer' ";
